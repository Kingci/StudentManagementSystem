...
<form id="form1" method="post" action="acdemicDean?action=deleteCourse">
<table width='75%'  class='TABLE_BODY' bordercolor='777777' border='1' style='border-color:#777777;border-collapse:collapse' align='center'>
  <%
	...
	if (courInfo != null && !courInfo.isEmpty()){
		out.println("<tr class='TABLE_TH'><td colspan='10' align='center'>可选课程</td></tr>");
  ...
  %>
  <tr>
  <td colspan='10' align='center'><input type="submit" name="delete" id="delete" value="删除" /></td>
  </tr>
</table>
