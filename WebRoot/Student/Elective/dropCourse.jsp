...
<form id="form1" method="post" action="student?action=dropCourse">
  <%
	...
	if (courInfo != null && !courInfo.isEmpty()){
		...
		out.println("<tr class='TABLE_TH'><td colspan='10' align='center'>课程退选</td></tr>");		
		...
		while(it.hasNext()){
  		...
  		out.println("<tr><td colspan='10' align='center'><input type='submit' name='1' id='12' value='退选' /></td></tr></table>");
	}
	else 
	{
		out.println("<tr><td>没有选择课程</td></tr>");
