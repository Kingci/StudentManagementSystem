  ...
  <%
	...
	if (courInfo != null && !courInfo.isEmpty()){
		...
		while(it.hasNext()){
  		...
  		if (flag == 1)
  			out.println("<tr class='TABLE_TR_01'><td colspan='4' align='center'><input type='submit' name='update' id='update' value='修改' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
  					"<input type='button' name='return' id='return' value='返回' onClick=\"window.location.href='index.jsp'\"/></td></tr></table>");
  		else 
  			out.println("<tr class='TABLE_TR_02'><td colspan='4' align='center'><input type='submit' name='update' id='update' value='修改' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
  					"<input type='button' name='return' id='return' value='返回' onClick=\"window.location.href='index.jsp'\"/></td></tr></table>");
	}
	else 
	{
