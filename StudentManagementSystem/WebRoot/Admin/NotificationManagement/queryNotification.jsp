...
<br/><br /><br /><br/>
  ...
  <%
	...
	if (courInfo != null && !courInfo.isEmpty()){
		...
		out.println("<tr class='TABLE_TR_01'><td >通知发布人</td><td >通知标题</td><td >通知内容</td></tr>");
		...
		while(it.hasNext()){
			...
			if (flag == 2) {
		  			out.println("<tr class='TABLE_TR_02'><td>"+ authorId +"</td>");
		  			flag = 1;
	  		}
	  		else if (flag == 1) {
	  			out.println("<tr class='TABLE_TR_01'><td>"+ authorId +"</td>");
	  			flag = 2;
	  		}
  		...
  		if (flag == 1)
  			out.println("<tr class='TABLE_TR_01'><td colspan='4' align='center'><input type='button' name='return' id='return' value='返回' onClick=\"window.location.href='index.jsp'\"/></td></tr></table>");
		else if(flag == 2)
  			out.println("<tr class='TABLE_TR_02'><td colspan='4' align='center'><input type='button' name='return' id='return' value='返回' onClick=\"window.location.href='index.jsp'\"/></td></tr></table>");
