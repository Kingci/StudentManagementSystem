...
<form id="form1" method="post" action="acdemicDean?action=updateNotification">
  <%
	...
	if (courInfo != null && !courInfo.isEmpty()){
		...
		out.println("<tr class='TABLE_TH'><td colspan='2' align='center'>已发布通知</td></tr>");
		...
		while(it.hasNext()){
			...
			out.println("<td valign='middle'><textarea name='"+notificationId+"' id='"+notificationId+"' cols='45' rows='10' style='height:100px;width:'530px'>"+content+"</textarea></td></tr>");
  		}
