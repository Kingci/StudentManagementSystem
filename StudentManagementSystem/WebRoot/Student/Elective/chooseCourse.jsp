  ...
  <%
  	...
  	if (account == null || "".equals(account)){
		...
		if (courInfo != null && !courInfo.isEmpty() && chooseCourseTimeForm != null &&(now.before(endTime) && now.after(beginTime))){
			...
			//out.println("<tr><td colspan='9' align='center'>可选课程</td></tr>");
			out.println("<tr class='TABLE_TH'><td colspan='10' align='center' >选课开始时间："+chooseCourseTimeForm.getBeginTime()+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结束时间："+chooseCourseTimeForm.getEndTime()+"</td></tr>");
		    out.println("<tr class='TABLE_TR_01'><td>课程号</td>	<td>课程中文名</td><td>课程英文名</td><td>学分数</td><td>周学时</td><td>学期</td><td>教学形式</td><td>开设院系</td><td>学年</td><td>选择</td></tr>");
			...
			while(it.hasNext()){
	  		...
	  		if (flag == 1)
	  			out.println("<tr class='TABLE_TR_01'><td colspan='10' align='center'><input type='submit' name='1' id='12' value='提交' /></td></tr></table>");
			else if (flag == 2) 
	  			out.println("<tr class='TABLE_TR_02'><td colspan='10' align='center'><input type='submit' name='1' id='12' value='提交' /></td></tr></table>");
